...
multilib_src_install_all() {
	...
	# Install mandatory files for raid scrubbing service
	insinto "/usr/bin"
	doins "${FILESDIR}/sbin/raid-check" || die
	insinto "/etc/conf.d"
	doins "${FILESDIR}/sysconfig/raid-check" || die
	insinto "/usr/lib/systemd/system/"
	doins "${FILESDIR}/raid-check.service" || die
	doins "${FILESDIR}/raid-check.timer" || die
}
